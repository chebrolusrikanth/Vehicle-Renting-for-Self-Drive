"""
Django settings for vcubeproject project.
...
SECRET_KEY = 'django-insecure-z#1o*t2lhkz(r9-mp0e%an!c@(x(8l^urgchx52f4nh!)vtr2n'
...
WSGI_APPLICATION = 'vcubeproject.wsgi.application'
